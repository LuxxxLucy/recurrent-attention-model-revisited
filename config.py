...
"""
Here comes  the new introduced parameters
"""
# the arguments for evaluations
evaluation_arg = add_argument_group('Variations of our algorithm.')
evaluation_arg.add_argument('--uncertainty', type=str2bool, default=False, help='self-uncertainty')
evaluation_arg.add_argument('--intrinsic', type=str2bool, default=False, help='the intrinsic regularizer')
evaluation_arg.add_argument('--dynamic', type=str2bool, default=False, help='use of dynamic decision')
evaluation_arg.add_argument('--no_tqdm', type=str2bool, default=True, help='use of tqdm')
evaluation_arg.add_argument('--dataset', type=str, default='translated', help='use of tqdm')
evaluation_arg.add_argument('--use_translate', type=str2bool, default=False, help='use of cluter')
evaluation_arg.add_argument('--lambda_intrinsic', type=float, default=1e-1, help='')
evaluation_arg.add_argument('--lambda_uncertainty', type=float, default=1e-5, help='')



"""
Below are the parameters of the original implementation
"""
...
reinforce_arg.add_argument('--std', type=float, default=0.10,
...
# train_arg.add_argument('--init_lr', type=float, default=1.4548e-05 ,
#                        help='Initial learning rate value')
